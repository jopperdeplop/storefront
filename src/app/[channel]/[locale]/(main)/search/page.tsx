...
// UPDATED: Now accepts locale
function SearchResults({ channel, locale }: { channel: string; locale: string }) {
	const { hits } = useHits();
				...
				<div className="mx-auto max-w-[1920px] px-4 pb-16 pt-8 md:px-8">
					<div className="flex flex-col gap-8 lg:flex-row">
						...
						<div className="flex-1">
							<NoResultsBoundary />
							{/* UPDATED: Pass locale */}
							<SearchResults channel={channel} locale={locale} />
							<CustomPagination />
						</div>
					</div>
				</div>
